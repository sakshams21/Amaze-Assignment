...
namespace StarterAssets
{
	public class StarterAssetsInputs : MonoBehaviour
	{
		...
		public void PrimaryAttackInput(bool newAttackState)
		{
			primaryAttack = newAttackState;
            
        }

        public void SecondaryAttackInput(bool newAttackState)
        {
			secondaryAttack = newAttackState;
        }
